...
void rtl88eu_set_fw_rsvdpagepkt(struct rtl8xxxu_priv *priv, bool b_dl_finished)
{
...
void rtl88eu_set_fw_joinbss_report_cmd(struct rtl8xxxu_priv *priv, u8 mstatus)
{
	struct rtl_priv *rtlpriv = rtl_priv(hw);
	struct rtl_mac *mac = rtl_mac(rtl_priv(hw));
