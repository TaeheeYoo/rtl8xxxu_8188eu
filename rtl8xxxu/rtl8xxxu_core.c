...
static struct rtl8xxxu_reg32val rtl8188eu_phy_1t_init_table[] = {
	{0x800, 0x80040000}, {0x804, 0x00000003},
	{0x808, 0x0000fc00}, {0x80c, 0x0000000a},
	{0x810, 0x10001331}, {0x814, 0x020c3d10},
	{0x818, 0x02200385}, {0x81c, 0x00000000},
	...
	{0xf14, 0x00000003}, {0xf4c, 0x00000000},
	{0xf00, 0x00000300}, {0xffff, 0xffffffff},
};
...
static struct rtl8xxxu_reg32val rtl8xxx_agc_8188eu_std_table[] = {
					...
					u16 len)
{
	...
	if (status < 0 && count++ < 4) {
		...
		printk("Caller(0) is %pS\n", __builtin_return_address(0));
		printk("Caller(1) is %pS\n", __builtin_return_address(1));
		printk("Caller(2) is %pS\n", __builtin_return_address(2));
	}
	return status;
}

static u32 _usb_read_sync(struct rtl8xxxu_priv*priv, u32 addr, u16 len)
{
...
{
	return (u8)_usb_read_sync(priv, addr, 1);
}

u16 rtl8xxxu_read16(struct rtl8xxxu_priv *priv, u16 addr)
{
	return (u16)_usb_read_sync(priv, addr, 2);
}

u32 rtl8xxxu_read32(struct rtl8xxxu_priv *priv, u16 addr)
{
	return _usb_read_sync(priv, addr, 4);
}
...
void rtl8xxxu_gen1_init_phy_bb(struct rtl8xxxu_priv *priv)
{
	...
	if (priv->hi_pa)
		...
		rtl8xxxu_init_phy_regs(priv, rtl8188eu_phy_1t_init_table);
	else
...
#if 1
			ramask = (sta->supp_rates[0]);
			ramask &= 0x00000f00;
			ramask = (ramask & 0x0fffffff) | (4 << 28);
#endif
...
tx_out:
	...
	return;
#else
	usb_fill_bulk_urb(_urb, priv->udev, usb_sndbulkpipe(priv->udev, 2),
			  skb->data, skb->len, rtl8xxxu_tx_complete, skb);
	_urb->transfer_flags |= URB_ZERO_PACKET;
	
	usb_anchor_urb(_urb, &priv->tx_anchor);
			   ...
			   bool is_wow)
{
	...
	priv->fw_data = kmalloc(0x4000, GFP_ATOMIC);
	memcpy(priv->fw_data->data, firmware->data,
			firmware->size);
			  ...
			  const struct usb_device_id *id)
{
	...
	ret = request_firmware_nowait(THIS_MODULE, 1,
				      "rtlwifi/rtl8188eufw.bin", &udev->dev,
...
{USB_DEVICE_AND_INTERFACE_INFO(0x0bda, 0x0179, 0xff, 0xff, 0xff),
	.driver_info = (unsigned long)&rtl8188eu_fops},
{ }
};
